...
def base_info_outputs_data_from(args: Namespace, story_data: StoryData,
    ...
    if has_build_of(args, BuildType.OUTLINE):
        ...
        outline_counts = counts_data_from_outlines_outputs_data(formatted, rows)
    ...
    if has_build_of(args, BuildType.PLOT):
        ...
        plot_counts = counts_data_from_plots_outputs_data(formatted, rows)
    ...
    if has_build_of(args, BuildType.SCRIPT):
        ...
        script_counts = counts_data_from_scripts_outputs_data(formatted, rows)
    ...
    if has_build_of(args, BuildType.NOVEL):
        ...
        novel_counts = counts_data_from_novels_outputs_data(formatted, rows)
